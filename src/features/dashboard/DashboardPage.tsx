...
import { amarHishabRepo } from "@/features/amarHishab/repo";
  ...
  const moduleQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        amarHishab: {
          name: t("nav.amarHishab"),
          count: amarHishab ? 1 : 0,
          lastEditedAt: amarHishab?.updatedAt,
          lastPublished: getLatestSnapshot("AMAR_HISHAB_BENEFITS")?.publishedAt,
          lastPublishedVersion: getLatestSnapshot("AMAR_HISHAB_BENEFITS")?.version,
          openTo: "/campaign-outreach/cms/amar-hishab-benefits",
        },
      };
    },
  });
